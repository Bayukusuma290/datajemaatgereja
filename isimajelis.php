...
$dtMajelis = query("SELECT * FROM db_majelis");

if( isset($_POST["cari"])) {

  $dtMajelis = cariMjs($_POST["keyword"]);
    ...
    <div class="row no-gutters mt-5">
      <div class="col-md-2 bg-dark pt-4 mt-2 pr-3">
        <ul class="nav flex-column ml-3 mb-5">
          ...
          <li class="nav-item">
            <a class="nav-link text-white font-weight-bold" href="#"><i class="fa-solid fa-user-plus pr-3"></i>Data Majelis</a><hr class="bg-secondary">
          </li>
      ...
      <div class="col-md-10 pt-5 pl-3 pr-2">
        <h3 class="font-weight-bold">Data Majelis GKI PNIEL</h3><hr>
        ...
        <form action="" method="post">
          ...
          <a href="isimajelis.php" type="btn" class="btn btn-secondary btn-md">Clear</a>
        </form>
        ...
        <table class="table table-hover">
          <thead class="thead-dark">
            <tr>
              <th scope="col">No</th>
              <th scope="col">ID Majelis</th>
              <th scope="col">No KK</th>
              <th scope="col">Nama</th>
              <th scope="col">Tempat Lahir</th>
              <th scope="col">Tanggal Lahir</th>
              <th scope="col">Jabatan</th>
              <th scope="col">Tanggal Dilantik</th>
          ...
          <?php $i = 1; ?>
          <?php foreach ($dtMajelis as $row) : ?>
          <tbody>
            <tr>
              <th scope="row"><?= $i; ?></th>
              <td scope="row"><?= $row["id_majelis"]; ?></td>
              <td scope="row"><?= $row["no_kk"]; ?></td>
              <td scope="row"><?= $row["nama"]; ?></td>
              <td scope="row"><?= $row["tempat_lahir"]; ?></td>
              <td scope="row"><?= $row["tgl_lahir"]; ?></td>
              <td scope="row"><?= $row["jabatan"]; ?></td>
              <td scope="row"><?= $row["tgl_dilantik"]; ?></td>
              <td scope="row"><?= $row["tgl_berakhir"]; ?></td>
              ...
              <td scope="row">
                <div class="btn-group dropleft">
                  ...
                  <div class="dropdown-menu">
                    <!-- Dropdown menu links -->
                      <a class="dropdown-item" href="detailmajelis.php?id=<?= $row["no"];  ?>"><i class="fa-solid fa-circle-info"></i> Detail</a>
                      <a class="dropdown-item" href="ubahmajelis.php?id=<?= $row["no"];  ?>"><i class="fa-sharp fa-solid fa-pen-to-square"></i> Ubah</a>
                      <a class="dropdown-item" href="hapusmajelis.php?id=<?= $row["no"];  ?>"><i class="fa-sharp fa-solid fa-trash"></i> Hapus</a>
                  </div>
                </div>
