...
$dtJemaat = query("SELECT * FROM db_jemaat");

// tombol cari diklik

if( isset($_POST["cari"])) {

  $dtJemaat = cariJmt($_POST["keyword"]);
    ...
    <div class="row no-gutters mt-5">
      <div class="col-md-2 bg-dark pt-4 mt-2 pr-3">
        <ul class="nav flex-column ml-3 mb-5">
          ...
          <li class="nav-item">
            <a class="nav-link text-white font-weight-bold" href="#"><i class="fa-solid fa-people-group pr-3"></i>Data Jemaat</a><hr class="bg-secondary">
          </li>
      ...
      <div class="col-md-10 pt-5 pl-3 pr-2">
        <h3 class="font-weight-bold">Data Jemaat GKI PNIEL</h3><hr>
        <form action="" method="post">
          ...
          <a href="isijemaat.php" type="btn" class="btn btn-secondary btn-md">Clear</a>
        </form>
              ...
              <td scope="row">
                <div class="btn-group dropleft">
                  ...
                  <div class="dropdown-menu">
                    <!-- Dropdown menu links -->
                      <a class="dropdown-item" href="detailjemaat.php?id=<?= $row["no"];  ?>"><i class="fa-solid fa-circle-info"></i> Detail</a>
                      <a class="dropdown-item" href="ubahjemaat.php?id=<?= $row["no"];  ?>"><i class="fa-sharp fa-solid fa-pen-to-square"></i> Ubah</a>
                      <a class="dropdown-item" href="hapusjemaat.php?id=<?= $row["no"];  ?>"><i class="fa-sharp fa-solid fa-trash"></i> Hapus</a>
                  </div>
                </div>
