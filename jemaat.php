...
if( isset($_POST["submit"]) ) {
  ...
  if( jemaat($_POST) > 0 ) {
    ...
    echo "
      <script>
        alert('Data jemaat gagal ditambahkan ');
...
<html lang="en">
  ...
  <body>
    <div class="container shadow p-3 mt-4 mb-5 bg-white rounded">
      ...
      <h2 class="mt-5 mb-3 font-weight-bolder"> Input Data Jemaat</h2>
      <form action="" method="post">
        ...
        <div class="form-group font-weight-bold">
          <div class="row">
            ...
            <div class="col-md-9">          
              <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukan Nama Jemaat">
            </div>
          </div>
        </div>
        ...
        <div class="form-group font-weight-bold">
          <div class="row">
            ...
            <div class="col-md-9">          
              <input type="text" class="form-control" id="gelar" name="gelar" placeholder="Masukan Gelar Akademik Jemaat">
            </div>
          </div>
        </div>
        ...
        <div class="form-group font-weight-bold">
          <div class="row">
            ...
            <div class="col-md-9">          
              <input type="text" class="form-control" id="kerja" name="kerja" placeholder="Masukan Pekerjaan Jemaat">
            </div>
          </div>
        </div>
        ...
        <div class="form-group font-weight-bold">
          <div class="row">
            ...
            <div class="col-md-9">          
              <input type="text" class="form-control" id="suku" name="suku" placeholder="Masukan Asal Suku Jemaat">
            </div>
          </div>
        </div>
        ...
        <div class="form-group font-weight-bold">
          <div class="row">
            ...
            <div class="col-md-9">          
              <input type="text" class="form-control" id="domisili" name="domisili" placeholder="Masukan Tahun Domisili Jemaat">
            </div>
          </div>
        </div>
